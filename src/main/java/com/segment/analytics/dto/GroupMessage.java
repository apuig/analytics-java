...
public class GroupMessage extends Message {
    ...
    public GroupMessage(final String userId, final String groupId) {
        super(Type.group, userId);
        setGroupId(groupId);
    }

    public GroupMessage(final String userId, final String groupId, final Map<String, ?> traits) {
        this(userId, groupId);
        setTraits(traits);
    }
